...
fun error1(): Outer<A>.Inner<!WRONG_NUMBER_OF_TYPE_ARGUMENTS!><B><!>.Inner3<C, D> = null!!
...
fun error7(): test<String>.Outer.Obj.Nested2<A>.Inner5<!WRONG_NUMBER_OF_TYPE_ARGUMENTS!><B><!> = null!!
