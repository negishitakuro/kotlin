...
object FirCallableReferenceChecker : FirQualifiedAccessExpressionChecker() {
    ...
    private fun checkReferenceIsToAllowedMember(
        ...
        if (referredSymbol is FirValueParameterSymbol ||
            (referredSymbol is FirPropertySymbol && (referredSymbol.isLocal || reference.resolvedSymbol is FirBackingFieldSymbol))
        ) {
