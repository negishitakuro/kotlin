...
dependencies {
    ...
    Platform[203].orHigher {
        testApi(intellijDep()) { includeJars("intellij-deps-fastutil-8.3.1-3") }
    }
    testApi(intellijDep()) {
        includeJars(
            "jps-model",
    ...
    testApi(intellijDep()) { includeJars("platform-util-ui", "platform-concurrency", "platform-objectSerializer") }
    testApi(intellijDep()) { includeJars("platform-ide-util-io") }
    testApiJUnit5()
}
