...
class ResolvedDependency(
    ...
    val requestedVersionsByIncomingDependencies: MutableMap<ResolvedDependencyId, String>,
...
object ResolvedDependenciesSupport {
    ...
    fun deserialize(source: String, onMalformedLine: (lineNo: Int, line: String) -> Unit): Collection<ResolvedDependency> {
        ...
        val requestedVersionsByIncomingDependenciesIndices: MutableMap<ResolvedDependencyId, Map<Int, String>> = mutableMapOf()
        ...
        modules.forEach { module ->
            val requestedVersions: Map<Int, String> = requestedVersionsByIncomingDependenciesIndices[module.id] ?: return@forEach
            requestedVersions.forEach { (incomingDependencyIndex, requestedVersion) ->
